...
puts array.min_by {|n| n.length}

puts "-" * 10

puts array.count {|i| i.size == 6}

puts "-" * 10

puts array.count {|i| i[1,1] =~ /[A-Z]/}
...
i = 1
while i < 33
	number = array.count{|j| j.length == i + 1}
	puts "Il y a #{number} journalistes dont le handle comporte #{i} caractères."
	i = i + 1
end
